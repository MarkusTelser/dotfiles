...
let colors_name = "peachpuff_onsteroids"


hi SpecialKey term=bold ctermfg=4 guifg=Blue
hi NonText term=bold cterm=bold ctermfg=4 gui=bold guifg=Green
...
hi Cursor guifg=Green guibg=fg
...
hi Identifier term=underline ctermfg=Red guifg=Red
